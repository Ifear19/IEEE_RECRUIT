...
normalised=((matrix-np.min(matrix))/(np.max(matrix)-np.min(matrix)))#this operation will make the smallest value 0
#and largest value 1 and all other remaining values would be in between 0 an 1
